    ...
    fvv_bitstream_t                               *data)
{
  *self      = (fvv_profile_toolset_constraints_information_t){0};
  ...
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
                     ptc_one_v3c_frame_only_flag);
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
                     ptc_eom_constraint_flag);
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
                     ptc_max_map_count_minus1);
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
                     ptc_max_atlas_count_minus1);
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
                     ptc_multiple_map_streams_constraint_flag);
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
                     ptc_plr_constraint_flag);
  FVV_SET_SETTER_PTR(fvv_profile_toolset_constraints_information_t,
    ...
    fvv_profile_toolset_constraints_information_t *self)
{
  ...
  for (i = 0; i < self->ptc_num_reserved_constraint_bytes; i++)
  {
    buff->write_bits(buff,
                     ...
                     FVV_DESCRIPTOR_PTC_RESERVED_CONSTRAINT_BYTE);
  }
  return FVV_RET_SUCCESS;
}
    ...
    fvv_profile_toolset_constraints_information_t *other)
{
  ...
  self->set_ptc_max_map_count_minus1(self,
                                     other->ptc_max_map_count_minus1);
