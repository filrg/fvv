...
struct fvv_sample_stream_nal_unit_t
{
  ...
  FVV_DECLARE_SCALAR_SETTER_PTR(fvv_sample_stream_nal_unit_t,
                                ssnu_nal_unit_size);
  FVV_DECLARE_OBJ_SETTER_PTR(fvv_sample_stream_nal_unit_t,
                             nu,
                             fvv_nal_unit_t);
};
fvv_ret_t
...
fvv_ret_t fvv_sample_stream_nal_unit_copy_from(
    fvv_sample_stream_nal_unit_t *self,
    fvv_sample_stream_nal_unit_t *other);
FVV_DECLARE_SCALAR_SETTER(fvv_sample_stream_nal_unit_t,
                          ssnu_nal_unit_size);
FVV_DECLARE_OBJ_SETTER(fvv_sample_stream_nal_unit_t,
                       nu,
                       fvv_nal_unit_t);
