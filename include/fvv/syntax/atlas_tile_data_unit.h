...
struct fvv_atlas_tile_data_unit_t
{
  ...
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_atlas_tile_data_unit_t,
                                atdu_patch_mode);
  FVV_DECLARE_OBJ_SETTER_PTR(fvv_atlas_tile_data_unit_t,
                             spdu,
...
fvv_atlas_tile_data_unit_copy_from(fvv_atlas_tile_data_unit_t *self,
                                   fvv_atlas_tile_data_unit_t *other);
FVV_DECLARE_2D_ARR_SETTER(fvv_atlas_tile_data_unit_t,
                          atdu_patch_mode);
FVV_DECLARE_OBJ_SETTER(fvv_atlas_tile_data_unit_t,
                       spdu,
                       fvv_skip_patch_data_unit_t);
FVV_DECLARE_OBJ_SETTER(fvv_atlas_tile_data_unit_t,
                       pid,
