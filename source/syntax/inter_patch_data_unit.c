    ...
    fvv_bitstream_t                         *data)
{
  *self           = (fvv_inter_patch_data_unit_t){0};
  ...
  FVV_SET_SETTER_PTR(fvv_inter_patch_data_unit_t,
                     ipdu_2d_delta_size_x);
  FVV_SET_SETTER_PTR(fvv_inter_patch_data_unit_t,
                     ipdu_2d_delta_size_y);
...
fvv_ret_t
fvv_inter_patch_data_unit_destroy(fvv_inter_patch_data_unit_t *self)
{
  if (!self)
  {
  ...
  FVV_DESTROY_2D_ARR(fvv_inter_patch_data_unit_t,
                     ipdu_2d_delta_size_x);
  FVV_DESTROY_2D_ARR(fvv_inter_patch_data_unit_t,
                     ipdu_2d_delta_size_y);
...
fvv_ret_t
fvv_inter_patch_data_unit_pack(fvv_inter_patch_data_unit_t *self,
                               uint64_t                     tileID,
                               uint64_t                     patchIdx)
{
  if (!self)
  ...
  if (NumRefIdxActive > 1)
  {
    buff->write_bits(buff,
                     self->ipdu_ref_index[tileID][patchIdx],
                     FVV_BIT_IPDU_REF_INDEX,
                     FVV_DESCRIPTOR_IPDU_REF_INDEX);
  }
  buff->write_bits(buff,
                   self->ipdu_patch_index[tileID][patchIdx],
                   FVV_BIT_IPDU_PATCH_INDEX,
                   FVV_DESCRIPTOR_IPDU_PATCH_INDEX);
  buff->write_bits(buff,
                   self->ipdu_2d_pos_x[tileID][patchIdx],
                   FVV_BIT_IPDU_2D_POS_X,
                   FVV_DESCRIPTOR_IPDU_2D_POS_X);
  buff->write_bits(buff,
                   self->ipdu_2d_pos_y[tileID][patchIdx],
                   FVV_BIT_IPDU_2D_POS_Y,
                   FVV_DESCRIPTOR_IPDU_2D_POS_Y);
  buff->write_bits(buff,
                   self->ipdu_2d_delta_size_x[tileID][patchIdx],
                   FVV_BIT_IPDU_2D_DELTA_SIZE_X,
                   FVV_DESCRIPTOR_IPDU_2D_DELTA_SIZE_X);
  buff->write_bits(buff,
                   self->ipdu_2d_delta_size_y[tileID][patchIdx],
                   FVV_BIT_IPDU_2D_DELTA_SIZE_Y,
                   FVV_DESCRIPTOR_IPDU_2D_DELTA_SIZE_Y);
  buff->write_bits(buff,
                   self->ipdu_3d_offset_u[tileID][patchIdx],
                   FVV_BIT_IPDU_3D_OFFSET_U,
                   FVV_DESCRIPTOR_IPDU_3D_OFFSET_U);
  buff->write_bits(buff,
                   self->ipdu_3d_offset_v[tileID][patchIdx],
                   FVV_BIT_IPDU_3D_OFFSET_V,
                   FVV_DESCRIPTOR_IPDU_3D_OFFSET_V);
  buff->write_bits(buff,
...
fvv_ret_t fvv_inter_patch_data_unit_copy_from(
    fvv_inter_patch_data_unit_t *self,
    fvv_inter_patch_data_unit_t *other)
{
  if (!self)
  {
    return FVV_RET_UNINITIALIZED;
  }
  self->set_ipdu_ref_index(
      self, other->ipdu_ref_index, other->ipdu_ref_index_size);
  self->set_ipdu_patch_index(
      self, other->ipdu_patch_index, other->ipdu_patch_index_size);
  self->set_ipdu_2d_pos_x(
      self, other->ipdu_2d_pos_x, other->ipdu_2d_pos_x_size);
  self->set_ipdu_2d_pos_y(
      self, other->ipdu_2d_pos_y, other->ipdu_2d_pos_y_size);
  self->set_ipdu_2d_delta_size_x(self,
                                 other->ipdu_2d_delta_size_x,
                                 other->ipdu_2d_delta_size_x_size);
  self->set_ipdu_2d_delta_size_y(self,
                                 other->ipdu_2d_delta_size_y,
                                 other->ipdu_2d_delta_size_y_size);
  self->set_ipdu_3d_offset_u(
      self, other->ipdu_3d_offset_u, other->ipdu_3d_offset_u_size);
  self->set_ipdu_3d_offset_v(
      self, other->ipdu_3d_offset_v, other->ipdu_3d_offset_v_size);
  self->set_ipdu_3d_offset_d(
      self, other->ipdu_3d_offset_d, other->ipdu_3d_offset_d_size);
  self->set_ipdu_3d_range_d(
      self, other->ipdu_3d_range_d, other->ipdu_3d_range_d_size);
  self->set_pd(self, other->pd);
  return FVV_RET_SUCCESS;
}
FVV_DEFINE_2D_ARR_SETTER(fvv_inter_patch_data_unit_t, ipdu_ref_index);
FVV_DEFINE_2D_ARR_SETTER(fvv_inter_patch_data_unit_t,
                         ipdu_patch_index);
...
FVV_DEFINE_2D_ARR_SETTER(fvv_inter_patch_data_unit_t,
                         ipdu_3d_range_d);
FVV_DEFINE_OBJ_SETTER(fvv_inter_patch_data_unit_t,
                      pd,
                      fvv_plr_data_t);
// }