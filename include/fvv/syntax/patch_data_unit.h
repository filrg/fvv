...
struct fvv_patch_data_unit_t
{
  ...
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_2d_size_x_minus1);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_2d_size_y_minus1);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_3d_offset_u);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_3d_offset_v);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_3d_offset_d);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_3d_range_d);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_projection_id);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_orientation_index);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_lod_enabled_flag);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_lod_scale_x_minus1);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_patch_data_unit_t, pdu_lod_scale_y_idc);
  FVV_DECLARE_OBJ_SETTER_PTR(fvv_patch_data_unit_t, pd, fvv_plr_data_t);
};
...
FVV_DECLARE_2D_ARR_SETTER(fvv_patch_data_unit_t, pdu_2d_size_x_minus1);
FVV_DECLARE_2D_ARR_SETTER(fvv_patch_data_unit_t, pdu_2d_size_y_minus1);
...
FVV_DECLARE_2D_ARR_SETTER(fvv_patch_data_unit_t, pdu_orientation_index);
FVV_DECLARE_2D_ARR_SETTER(fvv_patch_data_unit_t, pdu_lod_enabled_flag);
FVV_DECLARE_2D_ARR_SETTER(fvv_patch_data_unit_t, pdu_lod_scale_x_minus1);
