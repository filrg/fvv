    ...
    fvv_bitstream_t                         *data)
{
  *self           = (fvv_atlas_tile_layer_rbsp_t){0};
  ...
  FVV_SET_SETTER_PTR(
      fvv_atlas_tile_layer_rbsp_t, ath, fvv_atlas_tile_header_t);
  FVV_SET_SETTER_PTR(
      fvv_atlas_tile_layer_rbsp_t, atdu, fvv_atlas_tile_data_unit_t);
  FVV_SET_SETTER_PTR(
      fvv_atlas_tile_layer_rbsp_t, rtb, fvv_rbsp_trailing_bits_t);
  ...
  fvv_atlas_tile_data_unit_init(
      self->atdu, self->asps, self->afps, self->ath, data);
...
FVV_DEFINE_OBJ_SETTER(fvv_atlas_tile_layer_rbsp_t,
                      ath,
                      fvv_atlas_tile_header_t);
FVV_DEFINE_OBJ_SETTER(fvv_atlas_tile_layer_rbsp_t,
                      atdu,
                      fvv_atlas_tile_data_unit_t);
FVV_DEFINE_OBJ_SETTER(fvv_atlas_tile_layer_rbsp_t,
                      rtb,
