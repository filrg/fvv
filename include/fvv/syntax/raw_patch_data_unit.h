...
struct fvv_raw_patch_data_unit_t
{
  ...
  fvv_ret_t (*pack)(fvv_raw_patch_data_unit_t *self,
                    uint64_t                   tileID,
                    uint64_t                   patchIdx);
  fvv_ret_t (*copy_from)(fvv_raw_patch_data_unit_t *self,
                         fvv_raw_patch_data_unit_t *other);
  FVV_DECLARE_2D_ARR_SETTER_PTR(fvv_raw_patch_data_unit_t,
...
fvv_raw_patch_data_unit_copy_from(fvv_raw_patch_data_unit_t *self,
                                  fvv_raw_patch_data_unit_t *other);
FVV_DECLARE_2D_ARR_SETTER(fvv_raw_patch_data_unit_t,
                          rpdu_patch_in_auxiliary_video_flag);
