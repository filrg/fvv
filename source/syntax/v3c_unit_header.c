                                   ...
                                   fvv_bitstream_t       *data)
{
  *self           = (fvv_v3c_unit_header_t){0};
  ...
  FVV_SET_SETTER_PTR(fvv_v3c_unit_header_t,
...
fvv_ret_t fvv_v3c_unit_header_pack(fvv_v3c_unit_header_t *self)
{
  ...
  buff->write_bits(buff,
                   self->vuh_unit_type,
                   FVV_BIT_VUH_UNIT_TYPE,
                   FVV_DESCRIPTOR_VUH_UNIT_TYPE);
      ...
      self->vuh_unit_type == FVV_V3C_AD)
  {
    buff->write_bits(buff,
                     ...
                     FVV_DESCRIPTOR_VUH_V3C_PARAMETER_SET_ID);
    buff->write_bits(buff,
                     self->vuh_atlas_id,
                     FVV_BIT_VUH_ATLAS_ID,
                     FVV_DESCRIPTOR_VUH_ATLAS_ID);
  }
  if (self->vuh_unit_type == FVV_V3C_AVD)
  {
    buff->write_bits(buff,
                     ...
                     FVV_DESCRIPTOR_VUH_ATTRIBUTE_INDEX);
    buff->write_bits(buff,
                     self->vuh_attribute_partition_index,
                     FVV_BIT_VUH_ATTRIBUTE_PARTITION_INDEX,
                     FVV_DESCRIPTOR_VUH_ATTRIBUTE_PARTITION_INDEX);
    buff->write_bits(buff,
                     self->vuh_map_index,
                     FVV_BIT_VUH_MAP_INDEX,
                     FVV_DESCRIPTOR_VUH_MAP_INDEX);
    buff->write_bits(buff,
                     self->vuh_auxiliary_video_flag,
                     FVV_BIT_VUH_AUXILIARY_VIDEO_FLAG,
                     FVV_DESCRIPTOR_VUH_AUXILIARY_VIDEO_FLAG);
  }
  else if (self->vuh_unit_type == FVV_V3C_GVD)
  {
    ...
    buff->write_bits(buff,
                     ...
                     FVV_DESCRIPTOR_VUH_RESERVED_ZERO_12BITS);
  }
           ...
           self->vuh_unit_type == FVV_V3C_AD)
  {
    buff->write_bits(buff,
                     ...
                     FVV_DESCRIPTOR_VUH_RESERVED_ZERO_17BITS);
  }
  else
  {
    buff->write_bits(buff,
                     ...
                     FVV_DESCRIPTOR_VUH_RESERVED_ZERO_27BITS);
  }
  return FVV_RET_SUCCESS;
}
                                        ...
                                        fvv_v3c_unit_header_t *other)
{
  ...
  self->set_vuh_v3c_parameter_set_id(self,
                                     other->vuh_v3c_parameter_set_id);
  ...
  self->set_vuh_auxiliary_video_flag(self,
                                     other->vuh_auxiliary_video_flag);
  self->set_vuh_reserved_zero_12bits(self,
                                     other->vuh_reserved_zero_12bits);
  self->set_vuh_reserved_zero_17bits(self,
                                     other->vuh_reserved_zero_17bits);
  self->set_vuh_reserved_zero_27bits(self,
                                     other->vuh_reserved_zero_27bits);

  return FVV_RET_SUCCESS;
}
FVV_DEFINE_SCALAR_SETTER(fvv_v3c_unit_header_t, vuh_unit_type);
FVV_DEFINE_SCALAR_SETTER(fvv_v3c_unit_header_t,
