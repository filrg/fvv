...
fvv_ret_t fvv_plr_data_pack(fvv_plr_data_t *self, uint64_t tileID, uint64_t patchIdx)
{
  ...
  uint32_t         blockCnt = BlockCnt(TilePatch2dSizeX[tileID][patchIdx], TilePatch2dSizeY[tileID][patchIdx]);
...
fvv_ret_t fvv_plr_data_copy_from(fvv_plr_data_t *self, fvv_plr_data_t *other)
{
  ...
  self->set_plrd_level(self, other->plrd_level, other->plrd_level_size);
  self->set_plrd_present_block_flag(self, other->plrd_present_block_flag, other->plrd_present_block_flag_size);
  self->set_plrd_block_mode_minus1(self, other->plrd_block_mode_minus1, other->plrd_block_mode_minus1_size);
  self->set_plrd_present_flag(self, other->plrd_present_flag, other->plrd_present_flag_size);
  self->set_plrd_mode_minus1(self, other->plrd_mode_minus1, other->plrd_mode_minus1_size);
