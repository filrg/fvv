...
fvv_ret_t fvv_raw_patch_data_unit_init(fvv_raw_patch_data_unit_t *self, fvv_bitstream_t *data)
{
  *self           = (fvv_raw_patch_data_unit_t){0};
  ...
  FVV_SET_SETTER_PTR(fvv_raw_patch_data_unit_t, rpdu_patch_in_auxiliary_video_flag);
  FVV_SET_SETTER_PTR(fvv_raw_patch_data_unit_t, rpdu_2d_pos_x);
  FVV_SET_SETTER_PTR(fvv_raw_patch_data_unit_t, rpdu_2d_pos_y);
  FVV_SET_SETTER_PTR(fvv_raw_patch_data_unit_t, rpdu_2d_size_x_minus1);
  FVV_SET_SETTER_PTR(fvv_raw_patch_data_unit_t, rpdu_2d_size_y_minus1);
...
fvv_ret_t fvv_raw_patch_data_unit_destroy(fvv_raw_patch_data_unit_t *self)
{
  ...
  FVV_DESTROY_2D_ARR(fvv_raw_patch_data_unit_t, rpdu_patch_in_auxiliary_video_flag);
  FVV_DESTROY_2D_ARR(fvv_raw_patch_data_unit_t, rpdu_2d_pos_x);
  FVV_DESTROY_2D_ARR(fvv_raw_patch_data_unit_t, rpdu_2d_pos_y);
  FVV_DESTROY_2D_ARR(fvv_raw_patch_data_unit_t, rpdu_2d_size_x_minus1);
  FVV_DESTROY_2D_ARR(fvv_raw_patch_data_unit_t, rpdu_2d_size_y_minus1);
...
fvv_ret_t fvv_raw_patch_data_unit_copy_from(fvv_raw_patch_data_unit_t *self, fvv_raw_patch_data_unit_t *other)
{
  ...
  self->set_rpdu_patch_in_auxiliary_video_flag(self, other->rpdu_patch_in_auxiliary_video_flag, other->rpdu_patch_in_auxiliary_video_flag_size);
  self->set_rpdu_2d_pos_x(self, other->rpdu_2d_pos_x, other->rpdu_2d_pos_x_size);
  self->set_rpdu_2d_pos_y(self, other->rpdu_2d_pos_y, other->rpdu_2d_pos_y_size);
  self->set_rpdu_2d_size_x_minus1(self, other->rpdu_2d_size_x_minus1, other->rpdu_2d_size_x_minus1_size);
  self->set_rpdu_2d_size_y_minus1(self, other->rpdu_2d_size_y_minus1, other->rpdu_2d_size_y_minus1_size);
  self->set_rpdu_3d_offset_u(self, other->rpdu_3d_offset_u, other->rpdu_3d_offset_u_size);
  self->set_rpdu_3d_offset_v(self, other->rpdu_3d_offset_v, other->rpdu_3d_offset_v_size);
  self->set_rpdu_3d_offset_d(self, other->rpdu_3d_offset_d, other->rpdu_3d_offset_d_size);
  self->set_rpdu_points_minus1(self, other->rpdu_points_minus1, other->rpdu_points_minus1_size);
  return FVV_RET_SUCCESS;
}

FVV_DEFINE_2D_ARR_SETTER(fvv_raw_patch_data_unit_t, rpdu_patch_in_auxiliary_video_flag);
...
FVV_DEFINE_2D_ARR_SETTER(fvv_raw_patch_data_unit_t, rpdu_2d_size_x_minus1);
FVV_DEFINE_2D_ARR_SETTER(fvv_raw_patch_data_unit_t, rpdu_2d_size_y_minus1);
...
FVV_DEFINE_2D_ARR_SETTER(fvv_raw_patch_data_unit_t, rpdu_points_minus1);
// }
